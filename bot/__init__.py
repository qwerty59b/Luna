...
USER_MAX_TASKS = environ.get('USER_MAX_TASKS', '1')
USER_MAX_TASKS = '1' if len(USER_MAX_TASKS) == 0 else int(USER_MAX_TASKS)
...
REQUEST_LIMITS = environ.get('REQUEST_LIMITS', '4')
REQUEST_LIMITS = '4' if len(
    REQUEST_LIMITS) == 0 else max(int(REQUEST_LIMITS), 4)
